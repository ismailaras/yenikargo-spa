                ...
                <Container>
                    ...
                    <Collapse isOpen={isOpen} navbar>
                        <Nav className="ml-auto" navbar>
                            <div
                                className="nav_userinfo">{auth.currentEmployee.first_name} {auth.currentEmployee.last_name}
                                <div className="text-warning"> ({auth.currentEmployee.employee_role})</div>
                                - {auth.currentEmployee.station?.name}</div>
