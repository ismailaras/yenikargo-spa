        ...
        <div>
            <form onSubmit={onSubmit}>
                        ...
                        return (
                            <ListGroupItem key={c.id} className="mb-1 p-0">
                                <div className="d-flex justify-content-between align-items-center">
                                    <button disabled={handleSenderCustomer(c)} onClick={() => setSenderCustomer(c)}
                                            className="btn btn-warning px-5">G
                                    </button>
                                    <div>
                ...
                <button type="button" className="btn btn-outline-dark"
                     onClick={() => setIsBankAdd(!isBankAdd)}>Bank {isBankAdd ? "ləğv et" : "əlavə et"}</button>
                {isBankAdd && <>
                    ...
                    <div className="form-row">
                        <div className="col-md-12">
                            <TextInput
                                label="Bank üçün qeyd"
                                placeHolder="Qeydləri yazın"
                                name="bank_info"
                                value={values.bank_info}
                                error={errors.bank_info}
                                onChange={onChange}
                                onBlur={onBlur}
                                touched={touched.bank_info}
                            />
                        </div>
                    </div>
                </>
